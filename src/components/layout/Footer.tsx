      ...
      <div className="max-w-6xl mx-auto px-6 py-12 md:py-16">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-code-purple to-flow-blue flex items-center justify-center">
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
            ...
            <div>
              <span className="font-bold text-gallery-black">代码画廊</span>
              <span className="text-gallery-gray text-sm ml-2">
                让代码看得见
              </span>
            </div>
          </div>
        ...
        <div className="mt-8 pt-8 text-center">
          <p className="text-sm text-gallery-gray">
            © {new Date().getFullYear()} 代码画廊 · 让代码看得见
          </p>
        </div>
      </div>
    </footer>
