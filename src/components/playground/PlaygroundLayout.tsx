...
export default function PlaygroundLayout({ children }: PlaygroundLayoutProps) {
  return (
    <div className="h-screen flex flex-col bg-gallery-white">
      {/* Simplified top bar */}
      <header className="h-14 flex items-center px-4 bg-gallery-white flex-shrink-0">
        <Link
          href="/"
      ...
      {/* Main content */}
      <main id="main" className="flex-1 min-h-0 overflow-hidden flex flex-col">{children}</main>
    </div>
  );
}
