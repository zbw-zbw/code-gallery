...
s.peek();`,preAnalyzed:{success:!0,codeInput:{code:"",language:"javascript"},summary:"实现栈数据结构，支持 push、pop、peek 操作",executionSteps:[{stepNumber:1,lineNumber:9,description:"创建 Stack 实例 s",variables:[{name:"s",value:"Stack{#items:[]}",type:"object",changed:!0}],highlight:"normal"},{stepNumber:2,lineNumber:10,description:"调用 s.push('a')",variables:[{name:"item",value:"'a'",type:"string",changed:!0}],highlight:"function-call"},{stepNumber:3,lineNumber:3,description:"将 'a' 压入栈，#items = ['a']",variables:[{name:"#items",value:"['a']",type:"array",changed:!0}],highlight:"normal"},{stepNumber:4,lineNumber:11,description:"调用 s.push('b')",variables:[{name:"item",value:"'b'",type:"string",changed:!0}],highlight:"function-call"},{stepNumber:5,lineNumber:3,description:"将 'b' 压入栈，#items = ['a', 'b']",variables:[{name:"#items",value:"['a','b']",type:"array",changed:!0}],highlight:"normal"},{stepNumber:6,lineNumber:12,description:"调用 s.pop()，弹出栈顶元素",variables:[{name:"#items",value:"['a','b']",type:"array",changed:!1}],highlight:"function-call"},{stepNumber:7,lineNumber:4,description:"返回 'b'，#items = ['a']",variables:[{name:"#items",value:"['a']",type:"array",changed:!0}],highlight:"return"},{stepNumber:8,lineNumber:13,description:"调用 s.peek()，查看栈顶",variables:[{name:"#items",value:"['a']",type:"array",changed:!1}],highlight:"function-call"},{stepNumber:9,lineNumber:5,description:"返回栈顶元素 'a'，栈不变",variables:[{name:"#items",value:"['a']",type:"array",changed:!1}],highlight:"return"}],architecture:{nodes:[{id:"stack",label:"Stack",type:"class",description:"栈类"},{id:"push",label:"push()",type:"function"},{id:"pop",label:"pop()",type:"function"},{id:"peek",label:"peek()",type:"function"},{id:"items",label:"#items",type:"variable"}],edges:[{from:"stack",to:"push",label:"方法"},{from:"stack",to:"pop",label:"方法"},{from:"stack",to:"peek",label:"方法"},{from:"push",to:"items",label:"写入"},{from:"pop",to:"items",label:"读取并移除"},{from:"peek",to:"items",label:"只读"}],mermaidCode:`graph TD
    ...
    A[push 输入] -->|压入| B[栈存储]
    B -->|弹出| C[pop 输出]
    B -->|查看| D[peek 输出]`}}}];e.s(["CATEGORY_LABELS",0,{all:"全部",algorithm:"算法",pattern:"设计模式",async:"异步","data-structure":"数据结构"},"EXAMPLES",0,a])},57104,e=>{"use strict";var a=e.i(53286),t=e.i(94189),r=e.i(86046),i=e.i(26747),n=e.i(85149);function l({example:e}){let t=n.SUPPORTED_LANGUAGES.find(a=>a.value===e.language),r=e.code.split("\n").slice(0,3);return(0,a.jsxs)(i.default,{href:`/playground?example=${e.id}`,className:"group block rounded-2xl border border-gallery-border overflow-hidden bg-white hover:shadow-lg hover:-translate-y-1 transition-all duration-300",children:[(0,a.jsxs)("div",{className:"h-28 bg-code-bg relative overflow-hidden px-4 py-3",children:[(0,a.jsx)("div",{className:"space-y-1.5",children:r.map((e,t)=>(0,a.jsx)("div",{className:"h-3 rounded bg-gallery-gray/30",style:{width:`${40+50*Math.random()}%`}},t))}),(0,a.jsx)("div",{className:"absolute inset-0 bg-gradient-to-b from-transparent to-code-bg"})]}),(0,a.jsxs)("div",{className:"p-4",children:[(0,a.jsxs)("div",{className:"flex items-center gap-2 mb-2",children:[(0,a.jsx)("h3",{className:"text-sm font-medium text-gallery-black group-hover:text-code-purple transition-colors duration-200",children:e.title}),t&&(0,a.jsxs)("span",{className:"text-[10px] px-1.5 py-0.5 rounded bg-gallery-bg text-gallery-gray flex items-center gap-1",children:[(0,a.jsx)("span",{className:"w-1.5 h-1.5 rounded-sm inline-block",style:{backgroundColor:t.color}}),t.label]})]}),(0,a.jsx)("p",{className:"text-xs text-gallery-gray leading-relaxed mb-3",children:e.description}),(0,a.jsx)("span",{className:"text-xs text-code-purple font-medium group-hover:underline",children:"在 Playground 中打开 →"})]})]})}e.s(["default",0,function(){let[e,i]=(0,t.useState)("all"),n=Object.keys(r.CATEGORY_LABELS),s="all"===e?r.EXAMPLES:r.EXAMPLES.filter(a=>a.category===e);return(0,a.jsxs)("div",{children:[(0,a.jsx)("div",{className:"flex gap-2 mb-8 justify-center flex-wrap",children:n.map(t=>(0,a.jsx)("button",{onClick:()=>i(t),className:`px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200 ${e===t?"bg-code-purple text-white":"bg-gallery-bg text-gallery-gray hover:text-gallery-black"}`,children:r.CATEGORY_LABELS[t]},t))}),(0,a.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:s.map(e=>(0,a.jsx)(l,{example:e},e.id))})]})}],57104)}]);